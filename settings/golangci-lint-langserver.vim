augroup vim_lsp_settings_golangci_lint_langserver
  ...
  LspRegisterServer {
      ...
      \ 'cmd': {server_info->lsp_settings#get('golangci-lint-langserver', 'cmd', [lsp_settings#exec_path('golangci-lint-langserver'), 'run', '--enable-all', '--disable', 'lll', '--out-format', 'json'])},
