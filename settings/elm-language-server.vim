augroup vimlsp_settings_elm_language_server
  ...
  LspRegisterServer {
      ...
      \ 'root_uri':{server_info->lsp_settings#get('elm-language-server', 'root_uri', lsp#utils#path_to_uri(lsp#utils#find_nearest_parent_file_directory(lsp#utils#get_buffer_path(), ['.git/'])))},
      \ 'initialization_options': lsp_settings#get('elm-language-server', 'initialization_options', {"diagnostics": "true"}),
