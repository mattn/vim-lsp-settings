augroup vim_lsp_settings_angular_language_service
  ...
  LspRegisterServer {
      ...
      \ 'whitelist': lsp_settings#get('typescript-language-server', 'allowlist', {x-> empty(lsp_settings#root_path('angular.json')) ? [] : ['html']}),
      \ 'blacklist': lsp_settings#get('angular-language-service', 'blocklist', []),
